        ...
        <div class="logreg-box">
            <div class="form-box login">
                ...
                <form action="" name="form1" method="post">
                    ...
                    <div class="alert alert-success" id="success" style="margin-top: 10px; display: none; color: white">
                    <strong>Success!</strong> Account Registered Successfully.
                    </div>

                    <div class="alert alert-danger" id="error" style="margin-top: 10px; display: none; color: white">
